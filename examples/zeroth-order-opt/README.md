...
2. **Quantization-Aware**: Fine-tune quantized models directly; verified GGUF support includes `Q4_K_M`, `Q5_0`, `Q5_K_M`, `Q6_K`, and `Q8_0`, while the merge/save path remains extensible through generic ggml dequant/requant traits
